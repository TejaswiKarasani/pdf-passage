...
class Passage {
   ...
   */
    fetchJWKS(resetCache) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const jwks = yield axios_1.default
   ...
   */
    validAuthToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { kid } = jsonwebtoken_1.default.decode(token, { complete: true }).header;
                if (!kid) {
                    return undefined;
                }
                ...
                const userID = jsonwebtoken_1.default.verify(token, pem, {
                    // @ts-ignore
                    algorithms: jwk.alg,
                }).sub;
                if (userID)
